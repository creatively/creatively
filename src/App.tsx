      ...
      <main>
          ...
          <ul className="projects-list">
            ...
            <li className="projects-list__chat">
              <div className="projects-list-item-container">
                ...
                <div className="project__description">Calculates and graphs changes in climate data over the last 10 years for any global location. It calls a Node backend proxy API, that in turn calls a third-party past-weather data API. It then processes over 3,650 days of temperature data on the fly for any user-specified location.</div>
                <div className="project__skills-icons">
                  <img className="project__skills-icon" alt="javascript" src={require('./images/js-square-120h.png')} /> 
                  <img className="project__skills-icon" alt="typescript" src={require('./images/ts-square-120h.png')} /> 
                  <img className="project__skills-icon" alt="react" src={require('./images/react-120h.png')} /> 
        ...
        <section className="jobs">
          ...
          <div className="cv">
            ...
            <a className="cv-link" 
              title="cv link" 
              href={require('./files/chris-charles-cv.pdf')} 
              target="blank"
            >
